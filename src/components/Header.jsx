        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-x-4 xl:gap-x-5">
            ...
            >
              ...
              >
                <Link href="/contact" className="btn-primary whitespace-nowrap inline-block px-6 xl:px-10 py-3 xl:py-4 text-[9px] xl:text-[10px]">
                  GET QUOTE
                </Link>
              </motion.div>
            </motion.div>
          ...
          <>
            ...
            >
              <div className="flex justify-between items-center mb-10">
                <img src={logoImg.src || logoImg} alt="SMI Sportswear" className="h-16 md:h-20 w-auto object-contain opacity-90" />
