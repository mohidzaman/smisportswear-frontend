        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          ...
          >
            ...
            <h1 className="text-[clamp(3.5rem,8vw,7rem)] font-black text-white leading-[0.85] mb-12 uppercase tracking-tighter max-w-4xl">
              <span className="block italic text-white/90">ENGINEERED</span>
              <span className="text-primary italic text-glow">PROCESS</span>
            </h1>
          ...
          <div className="space-y-40">
            {steps.map((step, i) => (
              <motion.div 
                ...
                className={`flex flex-col lg:flex-row items-center gap-24 group ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}
              >
                <div className="w-full lg:w-1/2 flex justify-center relative">
                  ...
                  >
                    <div className="w-96 h-96 glass-apple rounded-[5rem] flex items-center justify-center border border-white/5 relative overflow-hidden shadow-premium transition-all duration-[1s] ease-apple">
                      ...
                      <div className="text-primary relative z-10 scale-[1.75] group-hover:scale-[2] transition-transform duration-[1s] ease-apple drop-shadow-[0_0_20px_rgba(193,18,31,0.3)]">
                        {step.icon}
                      </div>
                    </div>
                    <motion.div 
                      ...
                      className="absolute -top-10 -right-10 w-24 h-24 bg-primary rounded-full flex items-center justify-center text-white font-black text-4xl z-20 shadow-glow italic border-8 border-background-dark"
                    >
                      {i + 1}
                    </motion.div>
                  </motion.div>
                  <div className="absolute inset-0 bg-primary/10 blur-[150px] rounded-full z-0 opacity-0 group-hover:opacity-100 transition-all duration-1000" />
                </div>

                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  <h3 className="text-5xl md:text-7xl font-black text-white mb-10 uppercase tracking-tighter italic leading-none group-hover:text-primary transition-colors duration-700">{step.title}</h3>
                  <p className="text-white/30 text-xl font-medium leading-relaxed italic mb-16 max-w-lg mx-auto lg:mx-0">
                    {step.desc}
                  </p>
                  <div className="flex items-center justify-center lg:justify-start space-x-6 text-primary font-black text-[10px] tracking-[0.4em] uppercase group-hover:translate-x-6 transition-all duration-700 cursor-pointer italic">
                    <span className="border-b-2 border-primary/20 pb-2 group-hover:border-primary transition-all">{step.action}</span>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-8 sm:space-y-0 sm:space-x-12">
                ...
                >
                  <span className="tracking-[0.4em]">INITIATE ORDER</span>
